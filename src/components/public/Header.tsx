...
const Header = () => {
  return (
    <>
    <header className="max-xl:hidden fixed top-0 left-0 z-30 flex justify-between items-center backdrop-blur-sm  bg-white/70 h-20 px-20 max-lg:px-4 w-full">
      <Link
        to="/"
    ...
    <header className="xl:hidden fixed top-0 left-0 z-30 flex justify-between items-center backdrop-blur-sm  bg-white/70 h-20 px-20 max-lg:px-4 w-full">
      <Link
        to="/"
        className="flex gap-1 items-center justify-center h-12 cursor-pointer"
      >
